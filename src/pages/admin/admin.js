...
const renderPetRow = (p) => {
  ...
  return `
    <tr>
      <td data-label="Photo">${avatarHtml}</td>
      ...
      <td class="admin-cell-truncate admin-hide-mobile" data-label="Owner Email">${esc(p.owner_email)}</td>
...
const renderStoryRow = (s) => {
  ...
  return `
    <tr>
      ...
      <td class="admin-cell-truncate admin-hide-mobile" data-label="Owner Email">${esc(s.owner_email)}</td>
